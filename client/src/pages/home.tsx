...
import { Volume2, VolumeX, Volume1, Wifi, WifiOff, Settings, X, Minus, Plus, Speaker } from "lucide-react";
...
export default function Home() {
  ...
  const handleConnect = (conn: SpeakerConnection) => {
  ...
  if (!connection) {
    return (
      <ConnectionSetup onConnect={handleConnect} initialConnection={null} />
    );
  }
